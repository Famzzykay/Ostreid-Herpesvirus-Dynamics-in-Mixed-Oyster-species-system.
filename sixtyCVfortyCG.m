...
[sixtycvfortycgt,y]=ode45(@RHS_SIPD,tspan,y0);

%   Rename model results. New names for the plots.

sixtycvfortycgSCV=y(:,1); sixtycvfortycgSCG=y(:,2);sixtycvfortycgICV=y(:,3);sixtycvfortycgICG=y(:,4);sixtycvfortycgDCV=y(:,5); sixtycvfortycgDCG=y(:,6);sixtycvfortycgP=y(:,7);
